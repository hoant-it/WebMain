...
// bo sung ong chi trong chi tiet va bo loai chi R50
...
const tabPanelLoad = (length,oderNo,khachHang) => {
    ...
    // wacoal_OrderTinhChi_ChiTiet_MaHang_Load_Web_V5
    var urlDatChiCT = "wacoal_OrderTinhChi_ChiTiet_MaHang_Load_Web_V6/";// cap nhat them so ong
          ...
          template() {
            return $("<div id='GridDatChiCT'>").dxDataGrid({
              ...
              columns: [
                ...
                // 24-03-2025 bo cot R50 edit by Thai Hoa
                // {
                //     caption: "R50",
                //     alignment:"center",
                //     columns: [{
